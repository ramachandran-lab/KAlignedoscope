...
## Example interface
<p align="center">
<img src="./figures/interface_capeverde.png" alt="KAlignedoscope's visualization of Cape Verde aligned modes" width="600">
</p>
...
We provide the clustering alignment results generated by *Clumppling*'s alignment of *ADMIXTURE* runs on the Cape Verde dataset (with 399 individuals). 
...
Unzip the attached ``capeverde_admixtureQ.zip``  and also get the attached ``capeverde_ind_labels.txt`` file.
...
We also provide the clustering alignment results, generated by *Clumppling*'s alignment of *ADMIXTURE* runs on the 1000 Genome Project dataset (with 2504 individuals). Similarly, the input data to *KAlignedoscope* was taken directly from the output data of *Clumppling*.
